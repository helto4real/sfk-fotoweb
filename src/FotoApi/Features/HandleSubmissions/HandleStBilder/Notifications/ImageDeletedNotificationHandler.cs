...
{
    [Transactional]
    public async Task Handle(ImageDeletedNotification notification, PhotoServiceDbContext db,
        CancellationToken cancellationToken)
    {
        var stBild = await db.StBilder.Where(e => e.ImageReference == notification.Id)
